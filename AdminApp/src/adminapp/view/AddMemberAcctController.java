...
public class AddMemberAcctController implements Initializable
{
    public AnchorPane root;
    public VBox vbox ;
    public HBox hbox0, hbox1, hbox2, hbox3, hbox5, hbox6, hbox7 ;
    public Label header, firstNameLbl, lastNameLbl, usernameLbl, dobLbl, phoneLbl, emailLbl, addressLbl ;
    public TextField firstNameField, lastNameField, usernameField, phoneField, emailField, addressField ;
    ...
    public void create()
    {
        ...
        if(firstNameField.getText().isBlank() || lastNameField.getText().isBlank() || usernameField.getText().isBlank() || dobPicker.getValue() == null || phoneField.getText().isBlank() || emailField.getText().isBlank() || addressField.getText().isBlank() || dobPicker.getValue() == null)
        {
        ...
        else
        {
            ...
            Account account = new Account("MEMBER", id, firstNameField.getText(), lastNameField.getText(), usernameField.getText(), password, LocalDate.now().toString()) ;
    ...
    private String generateID(String firstName, String lastName)
    {
        ...
        while(dataBaseController.getFromAccount(id, "MEMBER", "FirstName") != null) ;
